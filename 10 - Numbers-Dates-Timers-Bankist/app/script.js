...
const formatMovementDate = function (date, locale) {
  ...
  const dayPasses = calcDaysPasssed(new Date(), date);
...
// console.log(Math.max(2, 16, 23, 11, 2, 46, 7));
// console.log(Math.max(2, 16, 23, 11, 2, '46', 7));
...
// console.log(BigInt(123234235242353245345235234235));
// console.log(32423412342342341n * 12313123n);
...
// const now = new Date();
// console.log(now);
// console.log(new Date('May 04 2022 15:15:35'));
...
// const days1 = calcDaysPasssed(new Date(2037, 3, 14), new Date(2037, 3, 24));
// console.log(days1);
...
// const ingridients = ['Olives', 'Olives'];
